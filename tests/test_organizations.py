...
class TestOrganization:
    ...
    def test_EP1_CUR01506(self,driver, username, password):
        """
    ...
    @pytest.mark.parametrize("username, password, document_number", [("404477902", "1qazxsw2.24", "900739999")])
    ...
    @pytest.mark.parametrize("username, password, document_number", [("404477902", "1qazxsw2.24", "3563231")])
    ...
    @pytest.mark.parametrize("username, password", [("404477901", "1qazxsw2.24")])
